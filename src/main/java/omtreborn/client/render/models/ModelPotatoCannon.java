...
@OnlyIn(Dist.CLIENT)
public class ModelPotatoCannon extends AbstractTurretModel {

    private final ModelPart base, pole, boxUnder, boxLeft, boxRight, crossBar, barrel, chamber;

    public ModelPotatoCannon() {
        super(null, null);
    ...
    private static LayerDefinition createLayer() {
        ...
        root.addOrReplaceChild("barrel", CubeListBuilder.create().texOffs(36, 0).mirror().addBox(-1, -2, -11, 2, 3, 12), PartPose.offset(0, 15, 0));
        root.addOrReplaceChild("chamber", CubeListBuilder.create().texOffs(0, 4).mirror().addBox(-2, -3, 1, 4, 4, 4), PartPose.offset(0, 15, 0));
