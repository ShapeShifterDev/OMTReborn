...
@OnlyIn(Dist.CLIENT)
public class ModelMachineGun extends AbstractTurretModel {

    private final ModelPart base, pole, boxUnder, boxLeft, boxRight, crossBar, gunStock, shape1;
    ...
    public ModelMachineGun() {
        ...
        gunStock = root.getChild("gunStock"); shape1 = root.getChild("shape1");
    }
    ...
    private static LayerDefinition createLayer() {
        ...
        root.addOrReplaceChild("gunStock", CubeListBuilder.create().texOffs(36, 0).mirror().addBox(-2, -5, -2, 4, 8, 8), PartPose.offset(0, 15, 0));
        root.addOrReplaceChild("shape1", CubeListBuilder.create().texOffs(32, 21).mirror().addBox(-1, -2, -15, 2, 2, 14), PartPose.offset(0, 17, 0));
    ...
    @Override public void setRotationForTarget(float pitchRad, float yawRad) {
        ...
        gunStock.xRot = pitchRad; gunStock.yRot = yawRad;
    ...
    @Override public void renderAll(PoseStack ps, VertexConsumer vc, int light, int overlay) {
        ...
        gunStock.render(ps, vc, light, overlay); shape1.render(ps, vc, light, overlay);
    }
}
